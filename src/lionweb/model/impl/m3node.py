...
class M3Node(Generic[T], Node, IKeyed[T], AbstractClassifierInstance, ABC):
    ...
    def get_property_value(
        self, property: Union[str, "Property"], default_value: Any | None = None
    ) -> object | None:
    ...
    def get_containment_single_value(self, link_name: str) -> Node | None:
    ...
    def get_reference_single_value(self, link_name: str) -> object | None:
    ...
    def set_reference_single_value(self, link_name: str, value: Optional["ReferenceValue"]) -> None:
        if value is None:
    ...
    def add_reference_multiple_value(self, link_name: str, value: "ReferenceValue") -> None:
