...
class BuiltinIDsAndKeysTest(unittest.TestCase):
    def test_M3ElementsHasExpectedIDsIn2023_1(self):
        ...
        self.assertEqual(
            "-id-Concept-abstract",
            LionCore.get_concept(LionWebVersion.V2023_1).get_property_by_name("abstract").id,
        )
        self.assertEqual(
            "-id-Concept-extends",
            LionCore.get_concept(LionWebVersion.V2023_1).get_reference_by_name("extends").id,
        )
        self.assertEqual(
            "-id-Concept-implements",
            LionCore.get_concept(LionWebVersion.V2023_1).get_reference_by_name("implements").id,
        )

        self.assertEqual("-id-Interface", LionCore.get_interface(LionWebVersion.V2023_1).id)
        self.assertEqual(
            "-id-Interface-extends",
            LionCore.get_interface(LionWebVersion.V2023_1).get_reference_by_name("extends").id,
        )

        self.assertEqual("-id-Containment", LionCore.get_containment(LionWebVersion.V2023_1).id)
        self.assertEqual("-id-DataType", LionCore.get_data_type(LionWebVersion.V2023_1).id)
        self.assertEqual("-id-Enumeration", LionCore.get_enumeration(LionWebVersion.V2023_1).id)

        self.assertEqual(
            "-id-Enumeration-literals",
            LionCore.get_enumeration(LionWebVersion.V2023_1).get_containment_by_name("literals").id,
        )
        ...
        self.assertEqual(
            "-id-Feature-optional",
            LionCore.get_feature(LionWebVersion.V2023_1).get_property_by_name("optional").id,
        )

        self.assertEqual("-id-Classifier", LionCore.get_classifier(LionWebVersion.V2023_1).id)

        self.assertEqual(
            "-id-Classifier-features",
            LionCore.get_classifier(LionWebVersion.V2023_1).get_containment_by_name("features").id,
        )

        self.assertEqual("-id-Link", LionCore.get_link(LionWebVersion.V2023_1).id)
        self.assertEqual(
            "-id-Link-multiple",
            LionCore.get_link(LionWebVersion.V2023_1).get_property_by_name("multiple").id,
        )
        self.assertEqual(
            "-id-Link-type",
        ...
        self.assertEqual("-id-Language", LionCore.get_language(LionWebVersion.V2023_1).id)
        self.assertEqual(
            "LionCore-builtins-INamed-name",
            LionCore.get_language(LionWebVersion.V2023_1).get_property_by_name("name").id,
        )
        self.assertEqual(
            "-id-IKeyed-key",
            LionCore.get_language(LionWebVersion.V2023_1).get_property_by_name("key").id,
        )
        self.assertEqual(
            "-id-Language-dependsOn",
            LionCore.get_language(LionWebVersion.V2023_1).get_reference_by_name("dependsOn").id,
        )
        self.assertEqual(
            "-id-Language-entities",
            LionCore.get_language(LionWebVersion.V2023_1).get_containment_by_name("entities").id,
        )

    def test_M3ElementsHasExpectedIDsIn2024_1(self):
        self.assertEqual("-id-Concept-2024-1", LionCore.get_concept(LionWebVersion.V2024_1).id)
        self.assertEqual(
            "-id-Concept-abstract-2024-1",
            LionCore.get_concept(LionWebVersion.V2024_1).get_property_by_name("abstract").id,
        )

        self.assertEqual(
            "-id-Concept-extends-2024-1",
            LionCore.get_concept(LionWebVersion.V2024_1).get_reference_by_name("extends").id,
        )
        ...
        self.assertEqual(
            ...
            LionCore.get_enumeration(LionWebVersion.V2024_1).get_containment_by_name("literals").id,
        )
        ...
        self.assertEqual("-id-Feature-2024-1", LionCore.get_feature(LionWebVersion.V2024_1).id)

        self.assertEqual(
            "-id-Feature-optional-2024-1",
            LionCore.get_feature(LionWebVersion.V2024_1).get_property_by_name("optional").id,
        )
    ...
    def test_M3ElementsHasExpectedKeys(self):
        ...
        self.assertEqual("Link-type", LionCore.get_link().get_reference_by_name("type").key)
        ...
        self.assertEqual("IKeyed-key", LionCore.get_language().get_property_by_name("key").key)
        self.assertEqual(
            "Language-dependsOn",
