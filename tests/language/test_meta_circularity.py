...
class MetaCircularityTest(unittest.TestCase):
    def test_each_element_of_m3_has_right_concept(self):
        ...
        self.assertIs(LionCore.get_concept(), LionCore.get_containment().get_classifier())
        self.assertIs(LionCore.get_concept(), LionCore.get_data_type().get_classifier())
        self.assertIs(LionCore.get_concept(), LionCore.get_enumeration().get_classifier())
        self.assertIs(LionCore.get_concept(), LionCore.get_enumeration_literal().get_classifier())
        self.assertIs(LionCore.get_concept(), LionCore.get_feature().get_classifier())
        self.assertIs(LionCore.get_concept(), LionCore.get_classifier().get_classifier())
        ...
        self.assertIs(LionCore.get_concept(), LionCore.get_language_entity().get_classifier())
        self.assertIs(LionCore.get_concept(), LionCore.get_primitive_type().get_classifier())
        ...
        self.assertIs(LionCore.get_concept(), LionCore.get_annotation().get_classifier())
    ...
    def test_each_element_of_m2_has_right_concept(self):
        ...
        self.assertIs(LionCore.get_enumeration_literal(), EnumerationLiteral().get_classifier())
