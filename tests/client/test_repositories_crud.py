...
class RepositoriesCRUD(AbstractClientFunctionalTest):
    def test_list_repositories(self):
        ...
        repo_client = Client(lionweb_version=LionWebVersion.V2023_1, server_url=server_url)
    ...
    def test_create_repository(self):
        ...
        repo_client.create_repository(
            RepositoryConfiguration(name="a", lionweb_version=LionWebVersion.V2023_1, history=False)
        )
        repo_client.create_repository(
            RepositoryConfiguration(name="b", lionweb_version=LionWebVersion.V2023_1, history=True)
        )
        repo_client.create_repository(
            RepositoryConfiguration(name="c", lionweb_version=LionWebVersion.V2024_1, history=False)
        )
        repo_client.create_repository(
            RepositoryConfiguration(name="d", lionweb_version=LionWebVersion.V2024_1, history=True)
        )
        repos = repo_client.list_repositories()
        self.assertEqual(
            [
