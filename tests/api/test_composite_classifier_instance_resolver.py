...
from lionweb.api.composite_classifier_instance_resolver import CompositeClassifierInstanceResolver
...
class CompositeClassifierInstanceResolverTest(unittest.TestCase):
    def test_empty_composite_classifier(self):
        ...
        self.assertEqual(str(instance_resolver), "CompositeClassifierInstanceResolver([])")
