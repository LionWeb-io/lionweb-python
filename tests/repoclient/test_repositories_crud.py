...
from lionwebpython.repoclient.repo_client import RepoClient, RepositoryConfiguration
...
class RepositoriesCRUD(AbstractRepoClientFunctionalTest):
    ...
    def test_list_repositories(self):
        ...
        repo_client = RepoClient(lionweb_version=LionWebVersion.V2023_1, repo_url=model_repo_url)
        repos = repo_client.list_repositories()
        self.assertEqual([RepositoryConfiguration(
            name="default", lionweb_version=LionWebVersion.V2023_1, history=False)], repos)
